    ...
    const CHANGELOG = [
        ...
        { version: '1.2.2', date: '2026-03-19', changes: ['Release parity update: web, desktop, and Android packages now ship from the same latest code state', 'Session History trigger moved inline next to the live session state chip to keep Session Tracker compact', 'Session History remains available in its dedicated modal with full timeline and clear action', 'General release packaging refresh for desktop installers and Android APK artifacts'] },
